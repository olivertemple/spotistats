...
export default class TrackCard extends Component{
    ...
    render(){
        return(
            <TouchableHighlight onPress={() => {this.props.showScreen({screen:"song",song:{id:this.props.id}})}}>
                <ImageBackground source={{uri:this.props.image}} style={{width:(Dimensions.get("window").width/2)-20, minHeight:150, justifyContent:"space-between", padding:10, margin:5}} imageStyle={{borderRadius:10, opacity:0.7}}>
